...
const Container = ({ src, alt, text, backgroundGradient }: ContainerProps) => {
    return ( 
        <div 
            className={`${backgroundGradient ? backgroundGradient : "text-black text-xs"} flex justify-center flex-col items-center py-[53px] md:py-28 xl:py-52 gap-3 text-white h-full`}
        >
